    ...
    <div className="sr-card flex flex-col items-center gap-6 px-6 py-10 text-center sm:py-14">
      {status === 'error' ? (
        ...
        <div className="flex flex-col items-center gap-3">
          <span className="sr-animate-recording-pulse inline-flex h-4 w-4 rounded-full bg-danger" />
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <button
            type="button"
            onClick={() => void start()}
            className="inline-flex items-center gap-2.5 rounded-full bg-accent px-8 py-3.5 text-base font-semibold text-accent-foreground transition-colors hover:opacity-90"
          >
            <IconRecord size={20} />
            Start recording
          </button>
